...
class EB extends Component<{name:string;children:ReactNode},EBState>{
  ...
  render(){
    if(this.state.hasError)return<div style={{padding:"1rem",color:"#f87171",background:"#1a0505",margin:"4px 0",borderRadius:"6px",fontSize:"11px",fontFamily:"monospace"}}>[{this.props.name}]: {this.state.msg}</div>;
