    ...
    <section id="education" className="py-20 bg-slate-950">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="space-y-6">
          {education.map((d, i) => (
            <div key={d.id || i} className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 hover:border-cyan-500/30 transition-all duration-300">
              ...
              {d.scholarship && (
                <div className="mb-3">
                  <span className="text-xs px-2 py-1 bg-amber-500/15 border border-amber-500/30 text-amber-400 rounded-full">🏆 {d.scholarship}</span>
                </div>
              )}
