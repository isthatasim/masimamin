...
const colorClasses = {
  cyan:    { border: 'border-cyan-500/30',   iconBg: 'bg-cyan-500/10',   icon: 'text-cyan-400',   badge: 'bg-cyan-500/10 text-cyan-400 border-cyan-500/20',   num: 'text-cyan-400' },
  indigo:  { border: 'border-indigo-500/30', iconBg: 'bg-indigo-500/10', icon: 'text-indigo-400', badge: 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20', num: 'text-indigo-400' },
  emerald: { border: 'border-emerald-500/30',iconBg: 'bg-emerald-500/10',icon: 'text-emerald-400',badge: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',num: 'text-emerald-400' },
};

export default function Education() {
  return (
    <section id="education" className="relative py-24 bg-[#060e1c] overflow-hidden">
      <div
        aria-hidden
